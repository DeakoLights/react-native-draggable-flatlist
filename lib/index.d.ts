...
> {
  ...
  panGestureHandlerRef: React.RefObject<
    React.ComponentType<
      import("react-native-gesture-handler").PanGestureHandlerProps &
  ...
  hoverAnimConfig: {
    ...
    overshootClamping: (boolean | Animated.Adaptable<number> | undefined) &
      boolean;
    restSpeedThreshold: (Animated.Adaptable<number> | undefined) & number;
    restDisplacementThreshold: (Animated.Adaptable<number> | undefined) &
      number;
  };
  ...
  static getDerivedStateFromProps<U>(
    props: DraggableFlatListProps<U>
  ): {
    extraData: any;
  };
  static defaultProps: {
